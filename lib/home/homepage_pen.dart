...
class HomePagePen extends StatefulWidget {
  const HomePagePen({super.key});

  @override
  State<HomePagePen> createState() => _HomePagePenState();
}

class _HomePagePenState extends State<HomePagePen> {
                ...
                builder: (BuildContext context,
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    snapshot.data!.docs.forEach((DocumentSnapshot doc) {
                      inventoryLevel = doc['inventory_level_pen'].toString();
                    });
                    return Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
