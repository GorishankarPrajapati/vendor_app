...
class PenRegisterPage extends StatefulWidget {
  const PenRegisterPage({super.key});

  @override
  State<PenRegisterPage> createState() => _PenRegisterPageState();
}

class _PenRegisterPageState extends State<PenRegisterPage> {
  ...
  Future signup(String name, String email, String password) async {
    try {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (BuildContext context) => const VendorPenlogin()));
